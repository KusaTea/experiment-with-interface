...
from data.models import EMGDataType, SensoGloveDataType, MarkupDataType
...
class DataMerger:
    ...
    def merge_data(self, emg_data: EMGDataType, sensoglove_data: SensoGloveDataType, markup_data: MarkupDataType):
