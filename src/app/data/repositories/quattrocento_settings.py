...
class QuattrocentoSettings:
    ...
    def construct_acquire_byte(self, acquire_byte_info: qtpe.AcquisitionByteDict) -> int:
        ...
        sampling_rate_encoded = sampling_rate_transform_dict[acquire_byte_info['sampling_rate']]
    ...
    def construct_front_panel_byte(self, front_panel_byte_info: qtpe.FrontPanelByteDict) -> int:
        ...
        return analog_output_gain_transform_dict[front_panel_byte_info['gain']] + front_panel_byte_info['source_channel']
    ...
    def construct_channel_byte(self, muscle_byte: qtpe.ChannelMuscleByteDict, electrode_adapter_byte: qtpe.ChannelElectrodeAdapterByteDict, last_byte: qtpe.ChannelLastByteDict) -> list:
        ...
        side_encoded = side_transform_dict[last_byte['side']]
        high_pass_filter_threshold_encoded = high_pass_filter_threshold_transform_dict[last_byte['high_pass_filter']]
        low_pass_filter_threshold_encoded = low_pass_filter_threshold_transform_dict[last_byte['low_pass_filter']]
        lead_mode_encoded = lead_mode_transform_dict[last_byte['mode']]
