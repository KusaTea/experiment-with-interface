...
from data.repositories import ExercisesData, MarkupDataCreater, SettingsData
from data.services import ExercisesIterator
...
class ExperimentWorker(QObject):
    ...
    def __create_markup_data_creater(self):
        self.__markup_creater = MarkupDataCreater(self.__dirs_store.raw_data_dir)
    ...
    @property
    def __rest_time_in_s(self) -> int:
        return self.__settings['experiment_settings']['rest_time_in_s']

    
    @property
    def __exercise_time_in_s(self) -> int:
        return self.__settings['experiment_settings']['exercise_time_in_s']
...
class ExperimentWindowController(QObject):
    ...
    def __init__(
        ...
        self.__experiment_window = window
        ...
        start_experiment_signal.connect(self.__start_experiment_thread)
    ...
    def __create_experiment_thread(self):
        ...
        self.__experiment_worker.event_green_color.connect(lambda: self.__experiment_window.change_background_image(choice(self.__backgrounds_images)))
